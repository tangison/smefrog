  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0B1121]">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-2xl mx-auto">
        ...
        >
          <span className="font-[Cabinet_Grotesk] text-sm font-bold text-red-400">Error</span>
          <span className="text-white/30">|</span>
          <span className="font-[Satoshi] text-sm text-white/50">
        ...
        >
          <button
            onClick={() => reset()}
            className="group inline-flex items-center gap-2 px-8 py-4 bg-[#7AC943] hover:bg-[#6BB838] text-[#0B1121] font-[Cabinet_Grotesk] font-bold text-base rounded-xl transition-all duration-300 hover:shadow-[0_0_30px_rgba(122,201,67,0.3)] cursor-pointer"
          >
        ...
        <motion.p
          ...
          className="mt-12 font-[Satoshi] text-sm text-white/25"
        >
