  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center overflow-hidden bg-frog-black">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/3 left-1/4 h-[400px] w-[400px] rounded-full bg-frog-green/3 blur-[120px]" />
      </div>
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-2xl mx-auto">
        ...
        >
          ...
          >
            ...
            {/* Green accent glow */}
            <div className="absolute -inset-4 rounded-3xl bg-frog-green/5 blur-xl -z-10" />
          </motion.div>
        </motion.div>
        ...
        >
          Something{' '}
          <span className="text-red-400">broke.</span>
        </motion.h1>
        ...
        >
          Try again or reach out for help.
        </motion.p>
        ...
        >
          <button
            onClick={() => reset()}
            className="group inline-flex items-center gap-2 min-h-[48px] px-8 py-4 bg-frog-green hover:bg-frog-green/90 text-frog-black font-bold text-base rounded-full transition-all duration-300 hover:shadow-[0_0_30px_rgba(122,201,67,0.3)] cursor-pointer touch-manipulation"
        ...
        <motion.p
          ...
          className="mt-12 text-sm text-white/25"
        >
