    ...
    <main className="min-h-screen">
      ...
      <section className="relative overflow-hidden bg-frog-black py-24 sm:py-32">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-40 -right-40 h-[500px] w-[500px] rounded-full bg-frog-green/5 blur-[120px]" />
          <div className="absolute -bottom-40 -left-40 h-[400px] w-[400px] rounded-full bg-frog-green/3 blur-[100px]" />
        </div>
        ...
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white tracking-tight">
              Privacy{' '}
              <span className="text-frog-green">Policy</span>
            </h1>
